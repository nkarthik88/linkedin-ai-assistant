...
export const config = {
  ...
  dodoProductIdLinkedIn: (process.env.DODO_PRODUCT_ID_LINKEDIN || process.env.DODO_PRODUCT_ID || "").trim(),
  dodoProductIdReddit:   (process.env.DODO_PRODUCT_ID_REDDIT   || "").trim(),
  dodoProductIdBundle:        (process.env.DODO_PRODUCT_ID_BUNDLE        || "").trim(),
  dodoProductIdBundleUpgrade: (process.env.DODO_PRODUCT_ID_BUNDLE_UPGRADE || "").trim(),
